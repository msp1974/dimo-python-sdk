class DeviceData:
    ...
    async def get_vehicle_history(
        self, privileged_token, token_id, start_time=None, end_time=None, buckets=None
    ):
        params = {}
    ...
    async def get_v1_vehicle_history(
        self, privileged_token, token_id, start_date=None, end_date=None
    ):
        params = {}
    ...
    async def get_user_device_history(
        self, access_token, user_device_id, start_date=None, end_date=None
    ):
        params = {}
        if start_date is not None:
            params["startDate"] = start_date
